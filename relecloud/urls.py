...
urlpatterns = [
    ...
    path('destination/<int:destination_id>/review/', views.ReviewCreateDestination.as_view(), name='review_destination'),
    ...
    path('cruise/<int:cruise_id>/review/', views.ReviewCreateCruise.as_view(), name='review_cruise'),
