...
# Configuración dual: SQLite para desarrollo local, PostgreSQL para Azure
if os.getenv('DBHOST'):
    # Azure PostgreSQL
    DATABASES = {
        'default': {
            ...
            'HOST': os.getenv('DBHOST', 'pris2.postgres.database.azure.com'),
            'USER': os.getenv('DBUSER', 'Luis'),
            'PASSWORD': os.getenv('DBPASS', 'Lu12042004'),
            'PORT': '5432',
            'OPTIONS': {
                'sslmode': 'require',
            },
...
CSRF_TRUSTED_ORIGINS = ['https://pris2.azurewebsites.net']
